  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($this->uri->segment(1)=="diagnosa"){echo "active"; } ?>">
        ...
        <?php if($this->session->userdata('id_admin')!=""){ ?>
          <li class="<?php if($this->uri->segment(1)=="penyakit"){echo "active"; } ?>">
            <a href="<?php echo base_url('penyakit') ?>"><i class="fa fa-object-group"></i>
            <span>Penyakit</span></a>
          </li>

          <li class="<?php if($this->uri->segment(1)=="gejala"){echo "active"; } ?>">
            <a href="<?php echo base_url('gejala') ?>"><i class="fa fa-puzzle-piece"></i> 
            <span>Gejala</span></a>
          </li>

          <li class="<?php if($this->uri->segment(1)=="knowledge"){echo "active"; } ?>">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        <strong> DIAGNOSA PENYAKIT MALARIA</strong>
      </h1>
    </section>
